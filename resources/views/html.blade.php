...
@section('welcome')
    ...
    @section('content')
         <div class="main-lang-pg__cards container">
            ...
            <div class="main-lang-pg__cards__styles">
                <div class="main-lang-pg__cards__styles__image">
                    <img src="{{asset('/public/img/main-images/training-previews/flexfroggy-logo.png')}}" alt="FlexBoxFroggy"
            ...
            <div class="main-lang-pg__cards__styles">
                <div class="main-lang-pg__cards__styles__image">
                    <img src="{{asset('/public/img/main-images/training-previews/cssdinner-logo.png')}}" alt="CSS Dinner" width="300px"
                        height="300px">
                </div>
                <div class="main-lang-pg__cards__styles__info">
                    <div class="main-lang-pg__cards__styles__info__name">
            ...
            <div class="main-lang-pg__cards__styles">
                <div class="main-lang-pg__cards__styles__image">
                    <img src="{{asset('/public/img/main-images/training-previews/htmlbook-logo.jpg')}}" alt="HTML BOOK" width="300px"
                        height="300px">
                </div>
                <div class="main-lang-pg__cards__styles__info">
                    <div class="main-lang-pg__cards__styles__info__name">
