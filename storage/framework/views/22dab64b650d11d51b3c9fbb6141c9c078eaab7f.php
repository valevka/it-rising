...
<div class="main-advantages container">
        ...
        <div class="main-start-learning">
            ...
            <p class="button-main-start-learning"><a href="<?php echo e(asset('/choose_lang#choose-prog-lang')); ?>">Начать</a></p>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\laravel\resources\views/welcome.blade.php ENDPATH**/ ?>