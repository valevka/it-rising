        ...
        <div class="main-lang-pg__cards container">
            ...
            <div class="main-lang-pg__cards__styles">
                <div class="main-lang-pg__cards__styles__image">
                    <img src="<?php echo e(asset('/public/img/main-images/training-previews/php-net-logo.jpg')); ?>" alt="Php net" width="300px"
                        height="300px">
                </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\laravel\resources\views/php.blade.php ENDPATH**/ ?>