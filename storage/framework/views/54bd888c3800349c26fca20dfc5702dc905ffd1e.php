        ...
        <div class="main-lang-pg__cards container">
            <div class="main-lang-pg__cards__styles">
                <div class="main-lang-pg__cards__styles__image">
                    <img src="<?php echo e(asset('/public/img/main-images/training-previews/codewars-logo.svg')); ?>" alt="Code Wars" width="300px"
                        height="300px">
                </div>
            ...
            <div class="main-lang-pg__cards__styles">
                <div class="main-lang-pg__cards__styles__image">
                    <img src="<?php echo e(asset('/public/img/main-images/training-previews/learnjs-logo.png')); ?>" alt="learn Js" width="300px"
                        height="300px">
                </div>
                <div class="main-lang-pg__cards__styles__info">
                    <div class="main-lang-pg__cards__styles__info__name">
            ...
            <div class="main-lang-pg__cards__styles">
                <div class="main-lang-pg__cards__styles__image">
                    <img src="<?php echo e(asset('/public/img/main-images/training-previews/html5book.png')); ?>" alt="Html Book" width="300px"
                        height="300px">
                </div>
                <div class="main-lang-pg__cards__styles__info">
                    <div class="main-lang-pg__cards__styles__info__name">
            ...
            <div class="main-lang-pg__cards__styles">
                <div class="main-lang-pg__cards__styles__image">
                    <img src="<?php echo e(asset('/public/img/main-images/training-previews/codebasics-logo.png')); ?>" alt="CodeBasics"
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\laravel\resources\views/js.blade.php ENDPATH**/ ?>