...
<div class="header-showcase container">
            <div class="header-showcase-text">
                ...
                <a href="<?php echo e(asset('/choose_lang#choose-prog-lang')); ?>" class="header-showcase-text-button">Начать</a>
            </div>
        ...
        <div class="language-cards-block row">
            ...
            <div class="main-training-list__languages">
                <ul>
                    ...
                    <a href="<?php echo e(asset('/python')); ?>">
                ...
                <ul class="main-training-list__languages__ul__last">
                    ...
                    <a href="<?php echo e(asset('/c_sharp')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\laravel\resources\views/choose_lang.blade.php ENDPATH**/ ?>